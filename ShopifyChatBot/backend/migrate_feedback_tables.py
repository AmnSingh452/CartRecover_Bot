...
async def create_feedback_tables():
    ...
    try:
        print("­ƒöä Creating customer feedback tables...")
        ...
        """)
        print("Ô£à Created customer_feedback table")
        ...
        """)
        print("Ô£à Created feedback_sessions table")
        ...
        print("Ô£à Created database indexes")
        ...
        """)
        print("Ô£à Inserted sample feedback data")
        
        print("\n­ƒÄë Database migration completed successfully!")
        print("\n­ƒôè Tables created:")
        print("   ÔÇó customer_feedback - Stores customer ratings and feedback")
        print("   ÔÇó feedback_sessions - Manages feedback links and tokens")
        print("\n­ƒöì Sample API endpoints available:")
        print("   ÔÇó POST /api/feedback/generate-feedback-link")
        print("   ÔÇó POST /api/feedback/submit")
        print("   ÔÇó GET /api/feedback/analytics/{shop_domain}")
        print("   ÔÇó GET /api/feedback/token/{feedback_token}")
        
    except Exception as e:
        print(f"ÔØî Error creating tables: {e}")
        raise
    finally:
        await conn.close()
